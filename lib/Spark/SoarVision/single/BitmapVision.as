package Spark.SoarVision.single
{
	 ...
	 * @author Andrew
		...
		@documentation 使用Bitmap型態的單一素材動態處理原型
	 */
	public class  BitmapVision extends Bitmap implements ITape
	{
		...
		public function BitmapVision(ID:String,pixelSnapping:String="auto",smoothing:Boolean=false):void
		{
		...
		public function VisionImage(value:Array):void
		{
			...
			this.bitmapData = this._arrSource[this._position-1];//陣列位置
		}
		
		public function get VisionRunner():Object {return this;}
