package Spark.SoarVision.single
{
	 ...
	 * @author Andrew
		...
		@documentation 使用Sprite型態的單一素材動態處理原型
	 */
	public class  SpriteVision extends Sprite implements ITape
	{
		 ...
		 */
		public function SpriteVision(ID:String,pixelSnapping:String="auto",smoothing:Boolean=false):void
		{
