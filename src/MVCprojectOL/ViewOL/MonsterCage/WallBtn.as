package MVCprojectOL.ViewOL.MonsterCage 
{
	 ...
	 * @author brook
	 */
	public class WallBtn implements IfMenuConter
	{
		...
		private var _BtnBoolean:Boolean = false;
		...
		private function _onClickHandler(e:MouseEvent):void
		{
			...
			{
				case "btn0":
					if (this._PageMaxNum[1] != 1) this._PageMaxNum[1] --;
					this._PageMaxNum[1] != this._PageMaxNum[0]?MovieClip(this._conter.getChildByName("btn1")).gotoAndStop(1):null;
					this._PageMaxNum[1] == 1?MovieClip(e.currentTarget).gotoAndStop(3):null;
				break;
				case "btn1":
					if (this._PageMaxNum[1] != this._PageMaxNum[0]) this._PageMaxNum[1] ++;
					this._PageMaxNum[1] != 1?MovieClip(this._conter.getChildByName("btn0")).gotoAndStop(1):null;
					this._PageMaxNum[1] == this._PageMaxNum[0]?MovieClip(e.currentTarget).gotoAndStop(3):null;
				break;
			}
			...
			this._funSend( MonsterCageStrLib.MouseHandler, _Wrap);
			//this._funSend( MonsterCageStrLib.PageTextComplete);
		}
		private function _onRollOverBtnHandler(e:MouseEvent):void
		{
			this._BtnBoolean = true;
			switch(e.currentTarget.name)
			{
				case "btn0":
					this._PageMaxNum[1] == 1?MovieClip(e.currentTarget).gotoAndStop(3):MovieClip(e.currentTarget).gotoAndStop(2);
				break;
				case "btn1":
					this._PageMaxNum[1] == this._PageMaxNum[0]?MovieClip(e.currentTarget).gotoAndStop(3):MovieClip(e.currentTarget).gotoAndStop(2);
				break;
			}
			
			//if (this._PageMaxNum[1] != 1 && e.currentTarget.name == "btn0") MovieClip(e.currentTarget).gotoAndStop(2);
			//if (this._PageMaxNum[1] != this._PageMaxNum[0] && e.currentTarget.name == "btn1") MovieClip(e.currentTarget).gotoAndStop(2);
		}
		private function _onRollOutBtnHandler(e:MouseEvent):void
		{
			this._BtnBoolean = false;
			switch(e.currentTarget.name)
			{
				case "btn0":
					this._PageMaxNum[1] == 1?MovieClip(e.currentTarget).gotoAndStop(3):MovieClip(e.currentTarget).gotoAndStop(1);
				break;
				case "btn1":
					this._PageMaxNum[1] == this._PageMaxNum[0]?MovieClip(e.currentTarget).gotoAndStop(3):MovieClip(e.currentTarget).gotoAndStop(1);
				break;
			}
		}
		...
		private function PageText():void
		{
			...
			if (this._PageMaxNum[1] == 1) {
				MovieClip(this._conter.getChildByName("btn1")).gotoAndStop(1);
				MovieClip(this._conter.getChildByName("btn0")).gotoAndStop(3);
			}
			(this._PageMaxNum[1] == 1)?Sprite(this._conter.getChildByName("btn0")).buttonMode = false:Sprite(this._conter.getChildByName("btn0")).buttonMode = true;
			(this._PageMaxNum[1] == this._PageMaxNum[0])?Sprite(this._conter.getChildByName("btn1")).buttonMode = false:Sprite(this._conter.getChildByName("btn1")).buttonMode = true;
		}
		...
		private function ConversionArrangedClickHandler(e:MouseEvent):void
		{
			...
			this._funSend( MonsterCageStrLib.AscendingOrDescending , _Wrap );
		}
		...
		private function onClickHandler(e:MouseEvent):void
		{
			...
			var _Wrap:Object = new Object();
				_Wrap["_sort"] = this._CurrentNumerical ;
				(this._CtrlNum == 1)?_Wrap["CtrlNum"] = 1:_Wrap["CtrlNum"] = -1;
			this._funSend( MonsterCageStrLib.SortNumerical , _Wrap );
		}
		...
		private function btnChange(e:MouseEvent):void 
		{
			switch (e.type) 
			{
				...
				case "click":
					...
					this._funSend(  MonsterCageStrLib.RemoveALL );
				break;
			}
		}
		...
		public function onRemove():void 
		{
			...
			while (this._conter.numChildren>0) this._conter.removeChildAt(0);
		}
