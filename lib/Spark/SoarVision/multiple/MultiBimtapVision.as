package Spark.SoarVision.multiple
{
	 ...
	 * @author Andrew
		...
		@documentation 使用Bitmap型態的多素材動態處理原型
	 */
		public class MultiBimtapVision extends BitmapVision implements ITape , IMultiTape
	{
		...
		public function MultiBimtapVision(ID:String,pixelSnapping:String="auto",smoothing:Boolean=false):void
		{
		...
		public function VisionOrder(cmd:String):void
		{
			if (cmd in this._objCmd) {
				...
				this.bitmapData = this._arrSource[this._position - 1];
			}else {//查無輸入指令
