package MVCprojectOL.ViewOL.LibraryView 
{
	 ...
	 * @author brook
	 */
	public class LibraryWallExitBtn implements IfMenuConter
	{
		...
		public function LibraryWallExitBtn() 
		{
			this._ary = [];
		}
		...
		private function btnChange(e:MouseEvent):void 
		{
			switch (e.type) 
			{
				...
				break;
			case "click":
				if (this._Layer != 2 && this._Layer != 3 && this._Layer != 4 && this._Layer != 5) this._funPublicfun("Exit");
					this._funSend(  UICmdStrLib.LibraryRemoveALL );
				break;
			}
		}
