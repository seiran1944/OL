	...
	public class LoaderControl
	{
		...
		{			
			if ( _InputQueue.length > 0 ) 
			{
				...
				//this._LoaderMaterial.addEventListener( "DataComplete" , this.DataCompleteHandler );//121221 K.J. Aris wasted
				this.QueueProcessing( this._QueueArr );//121221 K.J. Aris Added
