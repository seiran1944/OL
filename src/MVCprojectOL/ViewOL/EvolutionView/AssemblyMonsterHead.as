package MVCprojectOL.ViewOL.EvolutionView 
{
	 ...
	 * @author brook
	 */
	public class AssemblyMonsterHead 
	{
		private var _TipsView:TipsView = new TipsView("Evolution");//---tip---
		public function AddData(_InputSp:Sprite, _InputPic:Sprite, _InputData:Object, _BGObj:Object, _Y:int):Sprite
		{
			...
			var _ShowNameText:Text = new Text(_TextObj);
				_ShowNameText.x = 95;
				_ShowNameText.y = _Y + 2;
			_ListBoard.addChild(_ShowNameText);
			
			_TextObj._str = "Lv." + _InputData._lv + " ";
			_TextObj._col = 0xFFF337;
			...
			for (var i:int = 0; i < 6; i++) 
			{
				...
				if (i == 0) _TextObj._str = _InputData._nowHp;
				if (i == 1) _TextObj._str = _InputData._atk;
				if (i == 2) _TextObj._str = _InputData._def;
